...
public class Encryption {
  ...
  public static SecretKeySpec key() throws Exception {
    byte[] salt = new String("Web").getBytes();
    int iterationCount = 40000;
    int keyLength = 128;
    return Encryption.createSecretKey("Web".toCharArray(), salt, iterationCount, keyLength);
  }
